      ...
      Statement = [
        {
          ...
          Effect   = "Allow"
          Resource = [
            "arn:aws:logs:${data.aws_region.current.id}:${local.account_id}:*/*",
            "arn:aws:dynamodb:${data.aws_region.current.id}:${local.account_id}:*/*"
          ]
        }
      ]
    })
      ...
      Statement = [
        {
          ...
          Effect   = "Allow"
          Resource = [
            "arn:aws:ecs:${data.aws_region.current.id}:${local.account_id}:*/*",
            "arn:aws:cloudwatch:${data.aws_region.current.id}:${local.account_id}:*/*"
          ]
        }
      ]
    })
...
#todo: uncomment to show how resource change works in terraform
